...
<div class="bg-white">
    <section class="content content-boxed overflow-hidden">
        ...
        <div class="row push-20-t push-20">
            <div class="col-sm-5 col-lg-4 visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeInUp">
                <!-- Developer Plan -->
                <a class="block block-bordered block-link-hover3 text-center" href="javascript:void(0)">
                    <div class="block-header">
                        <h3 class="block-title">LynxPlus</h3>
                    </div>
                    <div class="block-content block-content-full bg-gray-lighter">
                        <div class="h1 font-w700 push-10">€5,99</div>
                        <div class="h5 font-w300 text-muted">1 Maand</div>
                    </div>
                    <div class="block-content">
                        <table class="table table-borderless table-condensed">
                            <tbody>
                                <tr>
                                    <td><strong>Lightning Deals</strong> van Amazon</td>
                                </tr>
                                <tr>
                                    <td><strong>Exclusieve LynxPlus kortingen</strong> voor <abbr title="GearBest">GB</abbr>, <abbr title="Banggood">BG</abbr>, <abbr title="LightInTheBox">LITB</abbr></td>
                                </tr>
                                <tr>
                                    <td><strong>Maandelijkse GRATIS</strong> Producten</td>
                                </tr>
                                <tr>
                                    <td>Een LynxPlus <strong>Badge</strong> <i class="fa fa-heart text-flat" style="color:CornflowerBlue"></i></td>
                                </tr>
                                <tr>
                                    <td><strong>Priority</strong> Support</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="block-content block-content-mini block-content-full bg-gray-lighter">
                        <span class="btn btn-default">Kopen met PayPal</span>
                    </div>
                </a>
                <!-- END Developer Plan -->
            </div>
            <div class="col-sm-5 col-lg-4 visibility-hidden" data-toggle="appear" data-offset="50" data-timeout="200" data-class="animated fadeInUp">
                <!-- Startup Plan -->
                <a class="block block-bordered block-link-hover3 text-center" href="frontend_signup.php">
                    <div class="block-header">
                        <h3 class="block-title text-primary">LynxPlus</h3>
                    </div>
                    <div class="block-content block-content-full bg-gray-lighter">
                        <div class="h1 font-w700 text-primary push-10">€29,99</div>
                        <div class="h5 font-w300 text-muted">6 Maanden</div>
                    </div>
                    <div class="block-content">
                        <table class="table table-borderless table-condensed">
                            <tbody>
                    ...
                    <div class="block-content block-content-mini block-content-full bg-gray-lighter">
                        <span class="btn btn-primary">Kopen met PayPal</span>
                    </div>
                </a>
                <!-- END Startup Plan -->
            </div>
            <div class="col-sm-5 col-lg-4 visibility-hidden" data-toggle="appear" data-offset="50" data-timeout="400" data-class="animated fadeInUp">
                <!-- Business Plan -->
                <a class="block block-bordered block-link-hover3 text-center" href="javascript:void(0)">
                    <div class="block-header">
                        <h3 class="block-title">LynxPlus</h3>
                    ...
                    <div class="block-content block-content-full bg-gray-lighter">
                        <div class="h1 font-w700 push-10">€49,99</div>
                        <div class="h5 font-w300 text-muted">12 Maanden</div>
                    </div>
                    <div class="block-content">
                        <table class="table table-borderless table-condensed">
                            <tbody>
